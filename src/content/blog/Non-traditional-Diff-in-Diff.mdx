...
<Color ruby>Important disclaimer:</Color> This post is not econometric theory. It does not prove anything for any non-traditional setting. I do, however, think it's useful to try and provide advice to applied folks on how to best answer a question until the econometric tools catch up.
