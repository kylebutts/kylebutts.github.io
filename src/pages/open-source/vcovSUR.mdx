...
title: "{vcovSUR}"
description: |
  An R package that allow estimation of the variance-covariance matrix and perform hypotheses tests acorss multiple regression equations.
layout: "../../layouts/ProseLayout.astro"
---
import { Bg, Color, Figure, LinkBlock, LargeBlock } from "../../components/mdx/"

# <a href="https://github.com/kylebutts/vcovSUR">vcovSUR</a>
...
This package was inspired by Peter Hull's tweet on ['stacking' regressions](https://twitter.com/instrumenthull/status/1492915860763250691) to compare coefficients across estimates. Instead
