---
title: 'Generalized Imputation Estimators for Factor Models'
author:
  - name: "Kyle Butts"
...
links:
  - name: Paper
    url: "../../files/Generalized_Imputation_Estimator.pdf"
  - name: Slides
    url: "../../files/Generalized_Imputation_Estimator_slides.pdf"
